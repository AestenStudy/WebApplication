INSERT INTO BUILDING(id, name, address) VALUES(-10, 'Building1', '158 Cours Fauriel');

INSERT INTO ROOM(id, name, floor, current_temp, target_temp, building_id) VALUES(-10, 'Room1', 1, 22.3, 20.0, -10);
